...
import '../css/Home.css'; // for custom styles if needed
    ...
    <div style={{ background: 'linear-gradient(135deg, #ffffff, #04749c)', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <nav className="navbar navbar-expand-lg navbar-dark" style={{ background: 'linear-gradient(135deg,#04749c,#ffffff)' }}>
        <div className="container">
          <Link className="navbar-brand fw-bold" to="/">VoxFix</Link>
          <button className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav">
            <span className="navbar-toggler-icon"></span>
          </button>
          <div className="collapse navbar-collapse justify-content-end navbar-black" id="navbarNav">
            <ul className="navbar-nav">
              <li className="nav-item">
                <Link className="nav-link active text-black" to="/home">Home</Link>
              </li>
              <li className="nav-item dropdown">
                <Link className="nav-link active text-black" to="/about">About Us</Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link active text-black" to="/contact">Contact Us</Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link active text-black" to="/login">Logout</Link>
              </li>
            </ul>
          </div>
        </div>
      ...
      <section className="bg-light py-5 text-center">
        <div className="container">
          ...
          <Link to="/tryit" className="btn btn-white btn-lg mt-4">Try It Now</Link>
        </div>
      </section>
            ...
            <div className="col-md-4 mb-4">
              <div className="card h-100 shadow-sm hover-scale">
                <div className="card-body">
                  ...
                  <p className="card-text">Just click the mic and start speaking. No typing needed!</p>
                </div>
              </div>
            </div>
            <div className="col-md-4 mb-4">
              <div className="card h-100 shadow-sm hover-scale">
                <div className="card-body">
                  ...
                  <p className="card-text">Instant feedback on grammar errors in your spoken sentences.</p>
                </div>
              </div>
            </div>
            <div className="col-md-4 mb-4">
              <div className="card h-100 shadow-sm hover-scale">
                <div className="card-body">
                  ...
                  <p className="card-text">Minimal interface, responsive design — perfect for all devices.</p>
                </div>
              </div>
            </div>
          </div>
